...
export async function Navbar() {
  ...
  return (
    <nav className="sticky top-4 z-50 mx-auto mt-4 w-[calc(100%-2rem)] max-w-4xl transform-gpu rounded-2xl border border-zinc-200/50 bg-white/95 shadow-sm dark:border-zinc-800/50 dark:bg-zinc-800/90 sm:bg-white/70 sm:backdrop-blur-md sm:dark:bg-zinc-800/50">
